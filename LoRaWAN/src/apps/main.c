...
int main( void )
{
    ...
    key.key_Pressed_callback = OnTxNextPacketTimerEvent;
    ...
    while( 1 )
    {
        switch( DeviceState )
        {
            ...
            case DEVICE_STATE_JOIN:
            {
                ...
                #if defined (USE_OLED)    
                    OLED_ShowString_Line(0,"OTAA joining     ");
                #endif           

                MSG_DBG("start OTAA joining\r\n");
#else
...
//                }
                ...
                DeviceState = DEVICE_STATE_SEND;
            #if defined (USE_OLED)      
                OLED_ShowString_Line(0,"ABP joining     ");
            #endif      
            ...
            case DEVICE_STATE_SEND:
            {
                if( NextTx == true )
                {
                    ...
                    MSG_DBG("send request...\r\n");
                    
                    GpioWrite(&Led_green,GPIO_PIN_SET);
                }
                if( ComplianceTest.Running == true )
                {
